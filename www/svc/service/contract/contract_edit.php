    ...
    <form method="post" action="p_realContract_edit.php">
                ...
                <div class="form-row">
                    ...
                    <div class="form-group col-md-2">
                       ...
                       while($row = mysqli_fetch_array($result)){?>
                            <option value="<?=$row['id']?>"
                                <?php if($row['id']===$row_main['group_in_building_id']){ echo "selected";} ?>>
                                <?=$row['gName']?></option>
                            <?php }?>
                        </select>
                    </div>
                    <div class="form-group col-md-2">
                      ...
                      while($row = mysqli_fetch_array($result)){?>
                            <option value="<?=$row['id']?>"
                                <?php if($row['id']===$row_main['r_g_in_building_id']){ echo "selected";} ?>>
                                <?=$row['rName']?></option>
                            <?php }?>
                        </select>
                    </div>
            ...
            <div class="form-group col-md-10 mb-0">
                <div class="form-row">
                    <div class="form-group col-md-2 mb-0">
                        ...
                        <input type="text" class="form-control text-right amountNumber" name="mAmount"
                            value="<?=$row_main['mAmount']?>" numberOnly required>
                    </div>
                    <div class="form-group col-md-2 mb-0">
                        <label>세액</label>
                        <input type="text" class="form-control text-right amountNumber" name="mvAmount"
                            value="<?=$row_main['mvAmount']?>" numberOnly required>
                    </div>
                    <div class="form-group col-md-2 mb-0">
                        <label>합계</label>
                        <input type="text" class="form-control text-right amountNumber" name="mtAmount"
                            value="<?=$row_main['mtAmount']?>" numberOnly readonly>
                    </div>
                    ...
                    <div class="form-group col-md-1 mb-0">
                        ...
                        <input type="number" class="form-control" name="monthCount" value="<?=$row_main['monthCount']?>"
                            min="1" max="72" required <?php if($step!='clear'){ echo "disabled";} ?>>
                    </div>
                    <div class="form-group col-md-2 mb-0">
                        <label><span id='star' style='color:#F7BE81;'>* </span>시작일자</label>
                        <input type="text" class="form-control dateType" name="startDate"
                            value="<?=$row_main['startDate']?>" placeholder="" required
                            <?php if($step!='clear'){ echo "disabled";} ?>>
                    </div>
                    <div class="form-group col-md-2 mb-0">
                        <label>종료일자</label>
                        <input type="text" id="endDate" name="endDate" class="form-control"
                            value="<?=$row_main['endDate']?>" readonly>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="">
            ...
            <a href='contract.php'><button type='button' class='btn btn-secondary'><i
                        class="fas fa-angle-double-right"></i>임대계약목록</button></a>
        </div>
    </form>
</section>
...
$('#select2').on('change', function(event) {
    ...
    $('#select5').empty();
    select5option = "<option value='" + buildingArray[buildingIdx][1] + "'>" + buildingArray[buildingIdx][1] +
        "</option>";
