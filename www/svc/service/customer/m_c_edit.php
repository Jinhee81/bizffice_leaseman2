            ...
            <div class="form-row">
                <div class="form-group col-md-3 mb-2">
                    ...
                    <select name="div1" class="form-control">
                        <option value="입주자" <?php if ($clist['div1'] === '입주자') {
                                                echo "selected";
                                            } ?>>입주자</option>
                        <option value="거래처" <?php if ($clist['div1'] === '거래처') {
                                                echo "selected";
                                            } ?>>거래처</option>
                        <option value="기타" <?php if ($clist['div1'] === '기타') {
                                                echo "selected";
                                            } ?>>기타</option>
                    </select>
                </div>
                <div class="form-group col-md-3 mb-1">
                    ...
                    <select name="div2" class="form-control">
                        <option value="개인" <?php if ($clist['div2'] === '개인') {
                                                echo "selected";
                                            } ?>>개인</option>
                        <option value="개인사업자" <?php if ($clist['div2'] === '개인사업자') {
                                                    echo "selected";
                                                } ?>>개인사업자</option>
                        <option value="법인사업자" <?php if ($clist['div2'] === '법인사업자') {
                                                    echo "selected";
                                                } ?>>법인사업자</option>
                    </select>
                </div>
                ...
                <div class="form-row">
                    ...
                    <div class="form-group col-md-3">
                        ...
                        <div class='form-check form-check-inline'>
                            <input class='form-check-input' type='radio' name='gender' id='inlineRadio1' value='남' <?php if ($row['gender'] === '남') {
                                                                                                                        echo "checked";
                                                                                                                    } ?>>
                            <label class='form-check-label'>남</label>
                        </div>
                        <div class='form-check form-check-inline'>
                            <input class='form-check-input' type='radio' name='gender' id='inlineRadio2' value='여' <?php if ($row['gender'] === '여') {
                                                                                                                        echo "checked";
                                                                                                                    } ?>>
